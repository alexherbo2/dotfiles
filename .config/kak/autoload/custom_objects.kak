...
map -docstring 'line' global object x 'c^\h*,\h*$<ret>'
...
map -docstring 'next parenthesis blocks' global object ) 'c<a-;><a-f>(\(,\)<ret>'
map -docstring 'previous brace blocks' global object { 'c<a-;><a-f>{\{,\}<ret>'
map -docstring 'next brace blocks' global object } 'c<a-;><a-f>{\{,\}<ret>'
map -docstring 'previous bracket blocks' global object [ 'c<a-;><a-f>[\[,\]<ret>'
map -docstring 'next bracket blocks' global object ] 'c<a-;><a-f>[\[,\]<ret>'
map -docstring 'previous angle blocks' global object <lt> 'c<a-;><a-f><lt><lt>,<gt><ret>'
map -docstring 'next angle blocks' global object <gt> 'c<a-;><a-f><lt><lt>,<gt><ret>'
