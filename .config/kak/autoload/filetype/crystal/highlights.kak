...
add-highlighter shared/crystal/comment/ regex '\B`[#.]?\w+[?!]?`\B|\B(?<!\*)\*\w+[?!]?\*(?!\*)\B|^\h*#\h*\K(?:BUG|DEPRECATED|EXPERIMENTAL|FIXME|NOTE|OPTIMIZE|TODO|WARNING)\b|^\h*#\h*\K:(?:ditto|nodoc|inherit):$' 0:meta
