...
add-highlighter shared/lua/code/instance-method-definition regex "\b(def)\h+(opt_lua_word_pattern_)\b" 1:keyword 2:function
add-highlighter shared/lua/code/class-method-definition regex "\b(def)\h+(self\.opt_lua_word_pattern_)\b" 1:keyword 2:function
add-highlighter shared/lua/code/method-call regex "\b(opt_lua_word_pattern_)\(" 1:function
...
#
add-highlighter shared/lua/comment/reference regex "`[#.]?opt_lua_word_pattern_`" 0:mono
...
# :"quoted symbol"
#
add-highlighter shared/lua/code/constant.symbol regex ":opt_lua_word_pattern_" 0:value
...
define-command -hidden lua-check-news %{
  ...
  execute-keys '%1<s>check_ident_or_keyword\(:(opt_lua_word_pattern_<a-!>),\h+\w+\)<ret>Z%1<s>@token\.value\h+=\h+:(opt_lua_word_pattern_<a-!>)<ret><a-z>a'
  ...
  execute-keys '%1<s>class="entry-detail"\h+id="(opt_lua_word_pattern_<a-!>)[^"]*-(method|macro)"<ret>'
  ...
  execute-keys '%1<s>class="entry-detail"\h+id="(opt_lua_word_pattern_<a-!>)[^"]*-(macro)"<ret>'
