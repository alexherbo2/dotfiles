...
set-face global StatusCursor "default,rgb:%opt{cursor}" # Cursor in command mode
...
set-face global StatusLineInactive "rgb:%opt{foreground},rgba:%opt{background_dark}%opt{selection_alpha}"
