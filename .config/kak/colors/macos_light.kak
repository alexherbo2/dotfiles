...
set-face global PrimaryCursorEol "rgb:%opt{foreground},rgb:%opt{cursor}+fg" # White (full block)
set-face global SecondaryCursorEol "rgb:%opt{foreground},rgb:%opt{selection}+fg" # White (full block)
