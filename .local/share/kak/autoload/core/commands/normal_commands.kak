...
map -docstring 'extend selected text to next search match' global normal <a-n> '?<ret>'
map -docstring 'extend selected text to previous search match' global normal <a-N> '<a-?><ret>'
