map -docstring 'move cursor visual line down' global normal 'j' 'gd'
map -docstring 'move cursor visual line up' global normal 'k' 'gu'
map -docstring 'extend cursor visual line down' global normal 'J' 'Gd'
map -docstring 'extend cursor visual line up' global normal 'K' 'Gu'
...
map global normal <c-down> ':move_selected_lines_down %val{count}<ret>'
map global normal <c-up> ':move_selected_lines_up %val{count}<ret>'
...
map -docstring 'enter search mode' global normal <a-space> ':enter_search_mode<ret>'
