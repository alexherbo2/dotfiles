...
map -docstring 'extend selected text to next search match' global normal n '?<ret>'
map -docstring 'extend selected text to previous search match' global normal N '<a-?><ret>'
