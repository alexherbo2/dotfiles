...
map -docstring 'next search match' global extend n ':reenter_extend_mode_after_key ?<lt>ret<gt><ret>'
map -docstring 'previous search match' global extend N ':reenter_extend_mode_after_key <lt>a-?<gt><lt>ret<gt><ret>'
