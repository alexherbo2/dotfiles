...
# kakoune: 2023-12-12
# license: MIT
# dependencies: ["enter_surround_mode"]
# doc: yes
# tests: no
...
map -docstring 'select inner nested objects' global match I <a-I>
map -docstring 'select whole nested objects' global match A <a-A>
