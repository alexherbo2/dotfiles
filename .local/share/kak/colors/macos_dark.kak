...
set-face global Selection "default,rgba:%opt{selection_color}%opt{selection_opacity}"
set-face global Cursor "default,rgba:%opt{cursor_color}%opt{cursor_opacity}"
