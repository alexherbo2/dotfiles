...
declare-option str text_color 'f5f5f5'
...
declare-option str red_color 'ff3333'
declare-option str green_color '40ff40'
declare-option str yellow_color 'ffff33'
declare-option str blue_color '4c4cff'
declare-option str magenta_color 'ff4cff'
declare-option str cyan_color '4cf3ff'
declare-option str white_color 'bfbfbf'
declare-option str bright_black_color '666666'
declare-option str bright_red_color 'ff7f7f'
declare-option str bright_green_color '73ff73'
declare-option str bright_yellow_color 'ffff7f'
declare-option str bright_blue_color '9999ff'
declare-option str bright_magenta_color 'ff7fff'
declare-option str bright_cyan_color '7fffff'
...
set-face global LineNumberCursor "@LineNumbers" # Kakoune ⇒ add-highlighter -override global/number-lines number-lines -hlcursor
...
# Custom faces
set-face global PrimaryCursorPlus ",,rgb:%opt{selection_color}+ua@PrimaryCursor"
set-face global PrimaryCursorEolPlus ",,rgb:%opt{selection_color}+ua@PrimaryCursorEol"
